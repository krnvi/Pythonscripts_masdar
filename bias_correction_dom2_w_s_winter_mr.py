...
A_bias_hour_wise=bias_hour_wise['2016-10-19 12':'2018-01-01 12'] #  pd.concat([bias_hour_day_1['2016-11-01':'2017-03-01'],bias_hour_day_1['2017-11-01':'2017-12-31']],axis=0)
mod_hour_wise=mod_hour_wise['2016-10-19 12':'2018-01-01 12']
obs_hour_wise=obs_hour_wise['2016-10-19 12':'2018-01-01 12']
...
#A_bias_hour_day1_winter=bias_hour_day_1['2017-04-20':'2017-12-31'] #  pd.concat([bias_hour_day_1['2016-11-01':'2017-03-01'],bias_hour_day_1['2017-11-01':'2017-12-31']],axis=0)
#
#
...
#
#mod_hour_day_1_winter=mod_hour_day_1['2017-04-20':'2017-12-31'] #pd.concat([mod_hour_day_1['2016-11-01':'2017-03-01'],mod_hour_day_1['2017-11-01':'2017-12-31']],axis=0)
#obs_hour_day_1_winter=obs_hour_day_1['2017-04-20':'2017-12-31'] #pd.concat([obs_hour_day_1['2016-11-01':'2017-03-01'],obs_hour_day_1['2017-11-01':'2017-12-31']],axis=0)
#
### mrio
#rmse_hour_avg_day1_winter.index=mod_hour_day_1_winter.index
#mr_input_winter=pd.concat([mod_hour_day_1_winter['mrio'],obs_hour_day_1_winter['mrio'],A_bias_hour_day1_winter['mrio'],rmse_hour_avg_day1_winter['mrio']],axis=1)
#mr_input_winter.columns=['mod','obs','bias','rmse']
#mr_input_winter['hour']=mod_hour_day_1_winter.index.hour
#mr_input_winter.insert(0,'Date',(mod_hour_day_1_winter.index.strftime('%m')).astype(int))
#
#mr_inputt=mr_input_winter ; 
#mr_input_1=pd.concat([(mr_inputt.iloc[0:-24]).reset_index(drop=True),mr_inputt['mod'].iloc[24:].reset_index(drop=True)],axis=1)
#mr_target=mr_inputt['obs'].iloc[24:]
#mr_input_1.columns=['Date', 'mod.p', 'obs', 'bias', 'rmse', 'hour', 'mod']
