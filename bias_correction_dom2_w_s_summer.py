...
m_dir='tmp_linear_dnn_bias-cor_full_'+str(itrn)+'.bsz_ep.'+str(epochs)+'_hu.'+str(h_size1)+'.'+str(h_size2)+'.1_Mn_2016_2017_summer'
    
reg_linear_dnn = tf.estimator.DNNLinearCombinedRegressor(linear_feature_columns=feature_cols,linear_optimizer='Ftrl',\
                 dnn_feature_columns=feature_cols,dnn_hidden_units=[h_size1,h_size2,1],dnn_activation_fn=tf.nn.relu,\
